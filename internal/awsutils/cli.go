...
// LambdaCommand is the command for the cli that does lambda related stuff
var LambdaCommand *cli.Command = &cli.Command{
	Name:  "lambda",
...
// CloudformationCommand is the command for the cli that does cloudformation related stuff
var CloudformationCommand *cli.Command = &cli.Command{
	Name:  "cloudformation",
